...
$.fn.SetEditable = function(t) {
    ...
    params = $.extend(n, t), this.find("thead tr").append('<th name="buttons">Action</th>'), this.find("tbody tr").append(colEdicHtml), $tab_en_edic = this, null != params.$addButton && params.$addButton.click(function() {
        rowAgreg()
